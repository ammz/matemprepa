...
\definefontfamily [office] [serif] [Times]
...
\setupheader[after={\vskip 4pt \hrule}]
...
\definetextbackground[trecuadro][%
  ...
  rightoffset=10pt,
  bottomoffset=3pt,
  before={\startpostponingnotes\blank[2*big]\vbox\bgroup},
  after={\egroup\blank[2*big]\stoppostponingnotes},
]
...
\definetextbackground [tbteor]  [trecuadro] [framecolor=color_teo]
\definetextbackground [tbdemo]  [tfondo]    [framecolor=color_teo, backgroundcolor=white]
\definetextbackground [tbdefi]  [trecuadro] [framecolor=color_def]
\definetextbackground [tbejem]  [tfondo]    [backgroundcolor=fondoejem]
...
\defineenumeration [ejemplo] [%
  ...
  color=darkgray,
  before={\blank[big]%
    \resetcounter[formula]\starttbejem},
  after={\resetcounter[formula]\stoptbejem},
]
...
%   {\inoutermargin{\vtop{\placelocalnotes[footnote][before=,after=]}}}
