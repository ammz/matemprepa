  ...
  \startchapter[title={Estructuras algebraicas y\\ estructuras analíticas}]
    ...
    \startsubsection[title={Propiedades de las operaciones binarias}]
      ...
      \startejemplos
        \startitemejem
          \startitem
            Las operaciones de unión, intersección \comentario{Ya se demostró que ${A \cap B} = {B \cap A}$ en \from[AE17B]} y diferencia simétrica son conmutativas.
          \stopitem
          \startitem
            Se puede verificar que la operación \quotation{chuma} es conmutativa. Para ello, habría que tomar cualesquiera dos elementos y operarlos en los dos órdenes.
          \stopitem
          \startitem
      ...
      \startejemplos
        \startitemejem
          \startitem
            Las operaciones de unión \comentario{Ya se demostró en \from[AE17B]} e instersección de conjuntos son asociativas.
          \stopitem
          \startitem
    ...
    \startsubsection[title={Relaciones}]
      ...
      \startejemplos
        \startitemejem
          ...
          \startitem
            D(escendiente) y H(ermano) no son órdenes parciales, ya que, por ejemplo, Eric noD Eris o Samuel noH Samuel.
          \stopitem
