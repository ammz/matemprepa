...
\project project_matemprepa
  ...
  \startchapter[title={Conjunto de los números cardinales}]
    ...
    \startdefinicion
      \margindata[comentario]{Recordemos que la cardinalidad de un conjunto es el número de elementos que hay en un conjunto.}
    ...
    \startaxioma
      \margindata[comentario]{Aceptamos que es una operación binaria sin discusión, ya que al estar uniendo conjuntos de cosas y el primer conjunto tiene una cardinalidad que es un número natural y el segundo también, al contarlos sale un conjunto que también tiene una cardinaliad que es un numero natural.}
    ...
    \startdemo
      ...
      \margindata[comentario]{$A \cap B = \emptyset --> a + b = \#(A \cup B) = \#A + \#B$}
      ...
      \margindata[comentario]{$(A \cup B) \cup C = A \cup (B \cup C)$}
    ...
    \startobservacion
      \margindata[comentario]{Aunque en este curso no vamos demostrarlo.}
    ...
    \startdemo
      ...
      \margindata[comentario]{Definición de multiplicación:\par$xy = \underbrace{y+y+y+\cdots+y}_{\text{x sumandos}}$}
    ...
    \startdemo
      \margindata[comentario]{Propiedad distributiva por la izquierda\par$x \ast (y \circ z) = (x \ast y) \circ (x \ast z)$}
    ...
    \startdemo
      ...
      \margindata[comentario]{Propiedad conmutativa\par$x \ast y = y \ast x$}
    ...
    \startdemo
      \margindata[comentario]{Propiedad distributiva por la derecha\par$(x \circ y) \ast z = (x \ast z) \circ (y \ast z)$}
    ...
    \startdemo
      \margindata[comentario]{1 es elemento identidad de la multiplicación en $\naturalnumbers$\par$x\cdot 1 = 1\cdot x = x$}
    ...
    \startdemo
      ...
      \margindata[comentario]{Unicidad del elemento identidad ($+$)\par$a + b = b + a = a --> b = 0$}
    ...
    \startdemop
      ...
      \startitemizep
        \startitem
          $i)\;$ Como por hipótesis $a \neq 0$, la división $\dfrac{a}{a}$ está definida. Luego, si $\dfrac{a}{a} = x$, por definición de división, $a = xa = ax$.
          \margindata[comentario]{Unicidad del elemento identidad ($\times$)\par$ab = ba = a --> b = 1$}
      ...
      $ii)\;$ Se demuestra de forma parecida. 
    \stopitemizep
    \stopdemop
